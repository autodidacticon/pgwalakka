...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = PgReplicationSlots.schema ++ SlotCatchup.schema
  ...
  case class PgReplicationSlotsRow(slotName: Option[String] = None, plugin: Option[String] = None, active: Option[Boolean] = None, activePid: Option[Int] = None, restartLsn: Option[String] = None, confirmedFlushLsn: Option[String] = None)

  /** GetResult implicit for fetching PgrRow objects using plain SQL queries */
  implicit def GetResultPgReplicationSlotsRow(implicit e0: GR[Option[String]], e1: GR[Option[Boolean]], e2: GR[Option[Int]]): GR[PgReplicationSlotsRow] = GR {
    prs =>
      import prs._
      PgReplicationSlotsRow.tupled((<<?[String], <<?[String], <<?[Boolean], <<?[Int], <<?[String], <<?[String]))
  }

  /** Table description of table pg_replication_slots. Objects of this class serve as prototypes for rows in queries. */
  class PgReplicationSlots(_tableTag: Tag) extends profile.api.Table[PgReplicationSlotsRow](_tableTag, "pg_replication_slots") {
    def * = (slotName, plugin, active, activePid, restartLsn, confirmedFlushLsn) <> (PgReplicationSlotsRow.tupled, PgReplicationSlotsRow.unapply)

    /** Database column slot_name SqlType(name), Default(None) */
    val slotName: Rep[Option[String]] = column[Option[String]]("slot_name", O.Default(None))
    /** Database column plugin SqlType(name), Default(None) */
    val plugin: Rep[Option[String]] = column[Option[String]]("plugin", O.Default(None))
    ...
    val activePid: Rep[Option[Int]] = column[Option[Int]]("active_pid", O.Default(None))
    /** Database column restart_lsn SqlType(pg_lsn), Length(2147483647,false), Default(None) */
    val restartLsn: Rep[Option[String]] = column[Option[String]]("restart_lsn", O.Length(2147483647, varying = false), O.Default(None))
    /** Database column confirmed_flush_lsn SqlType(pg_lsn), Length(2147483647,false), Default(None) */
    val confirmedFlushLsn: Rep[Option[String]] = column[Option[String]]("confirmed_flush_lsn", O.Length(2147483647, varying = false), O.Default(None))
  }

  /** Collection-like TableQuery object for table Pgr */
  lazy val PgReplicationSlots = new TableQuery(tag => new PgReplicationSlots(tag))
  ...
  case class SlotCatchupRow(slotName: Option[String] = None, catchupLsn: Option[String] = None)
  /** GetResult implicit for fetching SlotCatchupRow objects using plain SQL queries */
  implicit def GetResultSlotCatchupRow(implicit e0: GR[Option[String]]): GR[SlotCatchupRow] = GR{
    prs => import prs._
  ...
  class SlotCatchup(_tableTag: Tag) extends profile.api.Table[SlotCatchupRow](_tableTag, Some("walakka"), "slot_catchup") {
    ...
    val catchupLsn: Rep[Option[String]] = column[Option[String]]("catchup_lsn", O.Length(2147483647,varying=false), O.Default(None))
  }
