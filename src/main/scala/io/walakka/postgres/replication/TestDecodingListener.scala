...
class TestDecodingListener() extends PgLogicalDecodingListener {
  ...
  /**
    ...
    */
  override def enterLogline(
      ctx: PgLogicalDecodingParser.LoglineContext): Unit = {
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterTxStatement(
      ctx: PgLogicalDecodingParser.TxStatementContext): Unit = {}
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterDmlStatement(
      ctx: PgLogicalDecodingParser.DmlStatementContext): Unit = {
    msgBuilder.schemaName = Some(
      ctx.table().schemaname().Identifier().getSymbol.getText)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterInsertOp(
      ctx: PgLogicalDecodingParser.InsertOpContext): Unit =
    msgBuilder.transactionType = Some(DbMsgBuilder.Insert)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterUpdateOp(
      ctx: PgLogicalDecodingParser.UpdateOpContext): Unit =
    msgBuilder.transactionType = Some(DbMsgBuilder.Update)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterDeleteOp(
      ctx: PgLogicalDecodingParser.DeleteOpContext): Unit =
    msgBuilder.transactionType = Some(DbMsgBuilder.Delete)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterKeyValuePair(
      ctx: PgLogicalDecodingParser.KeyValuePairContext): Unit = resetDatum
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def exitKeyValuePair(
      ctx: PgLogicalDecodingParser.KeyValuePairContext): Unit =
    datumBuilder.getMetaTuple.map(msgBuilder.mergeMeta)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterValue(ctx: PgLogicalDecodingParser.ValueContext): Unit =
    datumBuilder.numData = Try(ctx.getText.toDouble).toOption
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def exitValue(ctx: PgLogicalDecodingParser.ValueContext): Unit =
    datumBuilder.getNumDataTuple.map(msgBuilder.mergeNumData)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterSchemaname(
      ctx: PgLogicalDecodingParser.SchemanameContext): Unit =
    msgBuilder.schemaName = Some(ctx.Identifier().getSymbol.getText)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterTablename(
      ctx: PgLogicalDecodingParser.TablenameContext): Unit =
    msgBuilder.tableName = Some(ctx.Identifier().getSymbol.getText)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterColumnname(
      ctx: PgLogicalDecodingParser.ColumnnameContext): Unit =
    datumBuilder.columnName = Some(ctx.Identifier().getSymbol.getText)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterTypedef(ctx: PgLogicalDecodingParser.TypedefContext): Unit =
    datumBuilder.dataType = Some(ctx.Identifier().getSymbol.getText)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def exitTypedef(
      ctx: PgLogicalDecodingParser.TypedefContext): Unit = {}
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterQuotedValue(
      ctx: PgLogicalDecodingParser.QuotedValueContext): Unit =
    datumBuilder.stringData = Some(
      ctx.QuotedString().getSymbol.getText.stripPrefix("'").stripSuffix("'"))
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def exitQuotedValue(
      ctx: PgLogicalDecodingParser.QuotedValueContext): Unit =
    datumBuilder.getStringDataTuple.map(msgBuilder.mergeStringData)
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def enterCommitTimestamp(
      ctx: PgLogicalDecodingParser.CommitTimestampContext): Unit = {}
  ...
  /**
    ...
    * @param ctx the parse tree
    */
  override def exitCommitTimestamp(
      ctx: PgLogicalDecodingParser.CommitTimestampContext): Unit = {}
}
